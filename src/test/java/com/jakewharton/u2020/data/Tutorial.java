...
public class Tutorial {
    ...
    public void testPractice() {
        ...
        transactions.stream().map(t->t.getTrader().getCity()).collect(Collectors.toSet()).forEach(System.out::println);
        ...
        System.out.println(transactions.stream().map(t->t.getTrader().getName()).distinct().sorted().reduce((a, b) -> {System.out.println(a + " "+ b); return a + " "+ b;}).orElse("empty"));
